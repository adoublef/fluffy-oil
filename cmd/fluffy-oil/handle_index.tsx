...
import { Font, Head, Html, Stylesheet } from "~/jsx/dom/mod.ts";
...
export function handleIndex(): Handler {
	return (c) => {
		const head = (
			<Head>
				<title>Home</title>
				{/* <Font href="/fonts/v/space_grotesk.woff2" /> */}
				{/* <Font href="/fonts/v/lexend.woff2" /> */}
				<Stylesheet href="/stylesheets/fonts.css?family=Alumni+Sans+Collegiate+One&family=IBM+Plex+Mono:wght@400;700&display=swap" />
				<Stylesheet href="/stylesheets/dummy.css" />
			</Head>
		);
			...
			<Html head={head}>
						...
						<ul>
							...
							<li>
								<button
									...
									_="on click toggle @hidden on #menu then if target's @aria-expanded is 'true' set target's @aria-expanded to 'false' else set target's @aria-expanded to 'true'"
								>
									More
								</button>
								<ul id="menu" hidden>
				...
				<main>
					...
					<section id="typography">
						<h2>Typography</h2>
						<p>
							Aliquam lobortis vitae nibh nec rhoncus. Morbi
							mattis neque eget efficitur feugiat. Vivamus porta
							nunc a erat mattis, mattis feugiat turpis pretium.
							{" "}
							<a href="#">
						...
						{/* <!-- Blockquote--> */}
						<blockquote>
							"Maecenas vehicula metus tellus, vitae congue turpis
							hendrerit non. Nam at dui sit amet ipsum cursus
							ornare."
							<footer>
						...
						<h3>Heading 3</h3>
						<p>
							Integer bibendum malesuada libero vel eleifend.
							Fusce iaculis turpis ipsum, at efficitur sem
							scelerisque vel. Aliquam auctor diam ut purus cursus
					...
					<article id="article">
						...
						<p>
							...
							vitae dolor. Sed ultricies dolor non ante{" "}
							<u>vulputate hendrerit</u>. Vivamus sit amet
							suscipit sapien. Nulla iaculis eros a elit pharetra
							egestas. Nunc placerat facilisis cursus. Sed
